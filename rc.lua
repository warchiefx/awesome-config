...
run_once({ "nm-applet", "setxkbmap -layout us_intl -option ctrl:swapcaps",
           "volumeicon", "compton --backend glx --glx-use-copysubbuffermesa", "xscreensaver -no-splash" })
-- }}}

-- {{{ Variable definitions
local chosen_theme = "powerarrow-wcx"
local modkey       = "Mod4"
local altkey       = "Mod1"
...
-- tag_names = { "main", "chat", "mail", "dev", "work", "media" }
-- awful.util.tagnames = tag_names
-- local l = awful.layout.suit  -- Just to save some typing: use an alias.
-- local layouts = { l.max, l.max, l.max, l.floating, l.max, l.floating}
...
--        layout = awful.layout.suit.floating,
--        class = {
--           "terminator", "emacs", "jetbrains-pycharm"
--        }
--     },
--     {
--        name = "work",
...
local tags = sharedtags({
    { name = "1:main", layout = awful.layout.suit.max },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey}, "F7", function()
          awful.util.spawn("autorandr", false)
    end),
